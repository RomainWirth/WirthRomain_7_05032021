    ...
    <div class="forum">
        <div class="forum__topics">
            ...
            <p class="forum__topics--picture">
                <img :src="'http://localhost:3000/'+Image" alt="conversation"> <!-- agrandir l'image au clic -->
            </p>
            ...
            <div class="forum__topics--details">
                ...
                <p> <!-- afficher si l'utilisateur est un modérateur : v-if u_level = 0 -->
            ...
            <p> <!-- afficher si auteur du message : comparer avec pseudo -->
                <button type="submit" v-on:click="showModify" v-if="!show">Modifier</button>
                <button type="submit" v-on:click="deleteMessage()" v-if="!show">Supprimer</button>
            </p>
            <p v-if="show">
...
<!-- au clic sur titre du topic : affichage de la div -->        
        <div class="forum__topics" v-if="answers"> 
            ...
            <div v-if="!showAnswer"> <!-- afficher si auteur du message : comparer avec pseudo -->
